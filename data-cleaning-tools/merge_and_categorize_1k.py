...
true_news = pd.read_csv('../data/DataSet_Misinfo_TRUE.csv', header=0, skiprows=[0], names=['ID', 'Article'], nrows=500)

# Load the fake news dataset
fake_news = pd.read_csv('../data/DataSet_Misinfo_FAKE.csv', header=0, skiprows=[0], names=['ID', 'Article'], nrows=500)
